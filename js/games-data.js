/* YADSTORE - DATA (dengan icon gambar asli via CDN) */
...
const GAMES = [
  ...
  { id: 'hok', name: 'Honor of Kings', icon: 'https://play-lh.googleusercontent.com/2QKd1lVWFKgqk4gC4t7NQqRtQw6kRqTqWQqLwRZqMqJqwLw7qKw2Qw=w240-h480', color: '#ffc107', category: 'game', desc: 'Top up Tokens',
...
console.log('[games-data] loaded: ' + GAMES.length + ' games + ' + DATA_PACKAGES.length + ' packages');
