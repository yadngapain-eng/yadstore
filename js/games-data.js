/* YADSTORE - DATA GAMES (icon pakai huruf, no URL) */

const GAMES = [
  { id: 'mlbb', name: 'Mobile Legends', icon: 'ML', color: '#1cb0f6', category: 'game', desc: 'Top up Diamond MLBB',
  ...
  { id: 'ff', name: 'Free Fire', icon: 'FF', color: '#ff4081', category: 'game', desc: 'Top up Diamond FF',
  ...
  { id: 'pubg', name: 'PUBG Mobile', icon: 'PB', color: '#ff9800', category: 'game', desc: 'Top up UC PUBG',
  ...
  { id: 'genshin', name: 'Genshin Impact', icon: 'GI', color: '#7c4dff', category: 'game', desc: 'Top up Genesis',
  ...
  { id: 'cod', name: 'COD Mobile', icon: 'CD', color: '#4caf50', category: 'game', desc: 'Top up CP COD',
  ...
  { id: 'valorant', name: 'Valorant', icon: 'VL', color: '#ff4655', category: 'game', desc: 'Top up VP',
  ...
  { id: 'roblox', name: 'Roblox', icon: 'RB', color: '#e91e63', category: 'game', desc: 'Top up Robux',
  ...
  { id: 'hok', name: 'Honor of Kings', icon: 'HK', color: '#ffc107', category: 'game', desc: 'Top up Tokens',
  ...
  { id: 'steam', name: 'Steam Wallet', icon: 'ST', color: '#607d8b', category: 'voucher', desc: 'Voucher Steam',
    fields: [],
    products: [
  ...
  { id: 'gplay', name: 'Google Play', icon: 'GP', color: '#4caf50', category: 'voucher', desc: 'Voucher Google Play',
    fields: [],
    products: [
...
const DATA_PACKAGES = [
  { id: 'telkomsel', name: 'Telkomsel', icon: 'TS', color: '#e60000', category: 'kuota', desc: 'Pulsa & Kuota',
  ...
  { id: 'indosat', name: 'Indosat', icon: 'IS', color: '#ffcc00', category: 'kuota', desc: 'Pulsa & Kuota',
  ...
  { id: 'xl', name: 'XL Axiata', icon: 'XL', color: '#00a651', category: 'kuota', desc: 'Pulsa & Kuota',
  ...
  { id: 'tri', name: 'Tri (3)', icon: 'TR', color: '#a83297', category: 'kuota', desc: 'Pulsa & Kuota',
  ...
  { id: 'smartfren', name: 'Smartfren', icon: 'SF', color: '#e60012', category: 'kuota', desc: 'Pulsa & Kuota',
  ...
  { id: 'axis', name: 'Axis', icon: 'AX', color: '#702082', category: 'kuota', desc: 'Pulsa & Kuota',
...
console.log('[games-data] loaded, GAMES=' + GAMES.length + ', PKG=' + DATA_PACKAGES.length);
