/* YADSTORE — LESSONS DATA */

const LESSON_CATEGORIES = {
  coding:  { label: 'Coding',  icon: '💻', color: '#1cb0f6' },
  english: { label: 'English', icon: '🇬🇧', color: '#ce82ff' },
  math:    { label: 'Matematika', icon: '🔢', color: '#ff9600' },
  science: { label: 'Sains',   icon: '🔬', color: '#58cc02' },
};

const CODING_LESSONS = [
  { id: 'c1', icon: '🌐', title: 'HTML Dasar', desc: 'Struktur halaman web', level: 'Pemula', xp: 10, questions: [
  ...
  { id: 'c2', icon: '🎨', title: 'CSS Dasar', desc: 'Styling halaman web', level: 'Pemula', xp: 10, questions: [
  ...
  { id: 'c3', icon: '⚡', title: 'JavaScript Dasar', desc: 'Bikin web interaktif', level: 'Pemula', xp: 15, questions: [
  ...
  { id: 'c4', icon: '🐍', title: 'Python Dasar', desc: 'Bahasa ramah pemula', level: 'Pemula', xp: 15, questions: [
  ...
  { id: 'c5', icon: '🌳', title: 'JavaScript DOM', desc: 'Manipulasi HTML', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c6', icon: '📐', title: 'CSS Flexbox', desc: 'Layout modern', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c7', icon: '🔲', title: 'CSS Grid', desc: 'Layout 2 dimensi', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c8', icon: '🔀', title: 'Git & GitHub', desc: 'Version control', level: 'Pemula', xp: 15, questions: [
  ...
  { id: 'c9', icon: '⏳', title: 'JavaScript Async', desc: 'Promise & async', level: 'Lanjutan', xp: 25, questions: [
  ...
  { id: 'c10', icon: '🧬', title: 'Python OOP', desc: 'Class & Object', level: 'Menengah', xp: 25, questions: [
  ...
  { id: 'c11', icon: '🗄️', title: 'SQL Dasar', desc: 'Database query', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c12', icon: '⚛️', title: 'React Dasar', desc: 'Library UI populer', level: 'Lanjutan', xp: 25, questions: [
...
const ENGLISH_LESSONS = [
  { id: 'e1', icon: '👋', title: 'Greetings', desc: 'Sapaan dasar', level: 'Beginner', xp: 10, questions: [
    ...
    { q: 'Balasan "I am fine" artinya?', o: ['Saya baik', 'Saya lapar', 'Saya lelah', 'Saya sibuk'], a: 0 },
    { q: '"Goodbye" artinya?', o: ['Halo', 'Selamat tinggal', 'Terima kasih', 'Maaf'], a: 1 },
  ]},
  { id: 'e2', icon: '🔢', title: 'Numbers', desc: 'Angka 1-100', level: 'Beginner', xp: 10, questions: [
  ...
  { id: 'e3', icon: '🎨', title: 'Colors', desc: 'Warna-warna', level: 'Beginner', xp: 10, questions: [
  ...
  { id: 'e4', icon: '👨‍👩‍👧', title: 'Family', desc: 'Anggota keluarga', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e5', icon: '🍔', title: 'Food & Drink', desc: 'Makanan & minuman', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e6', icon: '🏃', title: 'Verbs', desc: 'Kata kerja umum', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e7', icon: '⏰', title: 'Time & Days', desc: 'Waktu & hari', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e8', icon: '📝', title: 'Simple Present', desc: 'Tenses dasar', level: 'Intermediate', xp: 20, questions: [
  ...
  { id: 'e9', icon: '📚', title: 'Past Tense', desc: 'Waktu lampau', level: 'Intermediate', xp: 20, questions: [
    ...
    { q: 'V2 dari "take"?', o: ['taked', 'took', 'taken', 'taking'], a: 1 },
  ]},
  { id: 'e10', icon: '💼', title: 'Business English', desc: 'Bahasa Inggris kerja', level: 'Advanced', xp: 25, questions: [
    ...
    { q: '"Schedule" artinya?', o: ['Jadwal', 'Sekolah', 'Skema', 'Sistem'], a: 0 },
  ]},
  { id: 'e11', icon: '✈️', title: 'Travel', desc: 'Bahasa Inggris traveling', level: 'Intermediate', xp: 20, questions: [
  ...
  { id: 'e12', icon: '💬', title: 'Conversation', desc: 'Percakapan sehari-hari', level: 'Intermediate', xp: 20, questions: [
...
const MATH_LESSONS = [
  ...
  { id: 'm3', icon: '✖️', title: 'Perkalian', desc: 'Kali-kalian', level: 'Dasar', xp: 15, questions: [
...
const SCIENCE_LESSONS = [
  { id: 's1', icon: '🌍', title: 'Tata Surya', desc: 'Planet-planet', level: 'Dasar', xp: 15, questions: [
  ...
  { id: 's2', icon: '🧪', title: 'Kimia Dasar', desc: 'Unsur & senyawa', level: 'Dasar', xp: 15, questions: [
    { q: 'Simbol air?', o: ['CO2', 'H2O', 'O2', 'NaCl'], a: 1 },
    { q: 'Simbol oksigen?', o: ['O', 'O2', 'Ox', 'Og'], a: 1 },
    { q: 'Simbol emas?', o: ['Go', 'Au', 'Ag', 'Em'], a: 1 },
  ]},
  { id: 's3', icon: '🧬', title: 'Biologi', desc: 'Makhluk hidup', level: 'Dasar', xp: 15, questions: [
