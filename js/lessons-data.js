const LESSON_CATEGORIES = {
  coding:  { label: 'Coding',  icon: 'C', color: '#1cb0f6' },
  english: { label: 'English', icon: 'E', color: '#ce82ff' },
  math:    { label: 'Matematika', icon: 'M', color: '#ff9600' },
  science: { label: 'Sains',   icon: 'S', color: '#58cc02' },
};

const CODING_LESSONS = [
  { id: 'c1', icon: 'H', title: 'HTML Dasar', desc: 'Struktur halaman web', level: 'Pemula', xp: 10, questions: [
  ...
  { id: 'c2', icon: 'C', title: 'CSS Dasar', desc: 'Styling halaman web', level: 'Pemula', xp: 10, questions: [
  ...
  { id: 'c3', icon: 'J', title: 'JavaScript Dasar', desc: 'Bikin web interaktif', level: 'Pemula', xp: 15, questions: [
  ...
  { id: 'c4', icon: 'P', title: 'Python Dasar', desc: 'Bahasa ramah pemula', level: 'Pemula', xp: 15, questions: [
  ...
  { id: 'c5', icon: 'D', title: 'JavaScript DOM', desc: 'Manipulasi HTML', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c6', icon: 'F', title: 'CSS Flexbox', desc: 'Layout modern', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c7', icon: 'G', title: 'CSS Grid', desc: 'Layout 2 dimensi', level: 'Menengah', xp: 20, questions: [
  ...
  { id: 'c8', icon: 'G', title: 'Git & GitHub', desc: 'Version control', level: 'Pemula', xp: 15, questions: [
  ...
  { id: 'c9', icon: 'A', title: 'JavaScript Async', desc: 'Promise & async', level: 'Lanjutan', xp: 25, questions: [
  ...
  { id: 'c10', icon: 'O', title: 'Python OOP', desc: 'Class & Object', level: 'Menengah', xp: 25, questions: [
  ...
  { id: 'c11', icon: 'S', title: 'SQL Dasar', desc: 'Database query', level: 'Menengah', xp: 20, questions: [
    { q: 'Ambil semua data?', o: ['SELECT * FROM tabel', 'GET * FROM tabel', 'FETCH * tabel', 'TAKE * tabel'], a: 0 },
    { q: 'Filter data?', o: ['WHERE', 'FILTER', 'IF', 'WHEN'], a: 0 },
    { q: 'Urutkan naik?', o: ['ORDER BY ASC', 'SORT UP', 'ORDER ASC', 'SORT BY'], a: 0 },
  ]},
  { id: 'c12', icon: 'R', title: 'React Dasar', desc: 'Library UI populer', level: 'Lanjutan', xp: 25, questions: [
    { q: 'React dibuat oleh?', o: ['Google', 'Facebook', 'Microsoft', 'Amazon'], a: 1 },
    { q: 'File ekstensi React?', o: ['.jsx', '.react', '.rjs', '.js'], a: 0 },
    { q: 'State di function component?', o: ['useState', 'setState', 'state', 'this.state'], a: 0 },
  ]},
];

const ENGLISH_LESSONS = [
  { id: 'e1', icon: 'G', title: 'Greetings', desc: 'Sapaan dasar', level: 'Beginner', xp: 10, questions: [
    ...
    { q: 'Balasan "I am fine"?', o: ['Saya baik', 'Saya lapar', 'Saya lelah', 'Saya sibuk'], a: 0 },
    { q: '"Goodbye" artinya?', o: ['Halo', 'Selamat tinggal', 'Terima kasih', 'Maaf'], a: 1 },
  ]},
  { id: 'e2', icon: 'N', title: 'Numbers', desc: 'Angka 1-100', level: 'Beginner', xp: 10, questions: [
    { q: '"Five" artinya?', o: ['4', '5', '6', '7'], a: 1 },
    { q: 'Angka "10" dalam Inggris?', o: ['Ten', 'Nine', 'Eleven', 'Twelve'], a: 0 },
    { q: '"Twenty" artinya?', o: ['12', '20', '22', '200'], a: 1 },
    { q: '"One hundred" artinya?', o: ['10', '100', '1000', '1'], a: 1 },
  ]},
  { id: 'e3', icon: 'C', title: 'Colors', desc: 'Warna-warna', level: 'Beginner', xp: 10, questions: [
  ...
  { id: 'e4', icon: 'F', title: 'Family', desc: 'Anggota keluarga', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e5', icon: 'F', title: 'Food & Drink', desc: 'Makanan & minuman', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e6', icon: 'V', title: 'Verbs', desc: 'Kata kerja umum', level: 'Beginner', xp: 15, questions: [
  ...
  { id: 'e7', icon: 'T', title: 'Time & Days', desc: 'Waktu & hari', level: 'Beginner', xp: 15, questions: [
    ...
    { q: '"Sunday" artinya?', o: ['Sabtu', 'Minggu', 'Senin', 'Jumat'], a: 1 },
  ]},
  { id: 'e8', icon: 'P', title: 'Simple Present', desc: 'Tenses dasar', level: 'Intermediate', xp: 20, questions: [
  ...
  { id: 'e9', icon: 'P', title: 'Past Tense', desc: 'Waktu lampau', level: 'Intermediate', xp: 20, questions: [
  ...
  { id: 'e10', icon: 'B', title: 'Business English', desc: 'Bahasa kerja', level: 'Advanced', xp: 25, questions: [
  ...
  { id: 'e11', icon: 'T', title: 'Travel', desc: 'Bahasa traveling', level: 'Intermediate', xp: 20, questions: [
    { q: '"Airport" artinya?', o: ['Bandara', 'Pelabuhan', 'Stasiun', 'Terminal'], a: 0 },
    { q: '"Ticket" artinya?', o: ['Tiket', 'Karcis', 'Paspor', 'Visa'], a: 0 },
    { q: '"Luggage" artinya?', o: ['Koper', 'Tas kecil', 'Dompet', 'Jaket'], a: 0 },
    { q: '"Departure" artinya?', o: ['Keberangkatan', 'Kedatangan', 'Keterlambatan', 'Pembatalan'], a: 0 },
  ]},
  { id: 'e12', icon: 'C', title: 'Conversation', desc: 'Percakapan harian', level: 'Intermediate', xp: 20, questions: [
    { q: '"Excuse me" artinya?', o: ['Permisi', 'Maaf', 'Terima kasih', 'Halo'], a: 0 },
    { q: '"I do not understand" artinya?', o: ['Saya tidak mengerti', 'Saya mengerti', 'Saya tahu', 'Saya bingung'], a: 0 },
    { q: '"Can you help me?" artinya?', o: ['Bisakah kamu membantu saya?', 'Kamu di mana?', 'Siapa kamu?', 'Apa ini?'], a: 0 },
    { q: '"Nice to meet you" artinya?', o: ['Senang bertemu', 'Selamat jalan', 'Sampai jumpa', 'Apa kabar'], a: 0 },
  ]},
];

const MATH_LESSONS = [
  { id: 'm1', icon: '+', title: 'Penjumlahan', desc: 'Tambah-tambahan', level: 'Dasar', xp: 10, questions: [
    { q: '5 + 3 = ?', o: ['7', '8', '9', '10'], a: 1 },
    { q: '12 + 8 = ?', o: ['18', '19', '20', '21'], a: 2 },
    { q: '25 + 15 = ?', o: ['35', '40', '45', '50'], a: 1 },
  ]},
  { id: 'm2', icon: '-', title: 'Pengurangan', desc: 'Kurang-kurangan', level: 'Dasar', xp: 10, questions: [
    { q: '10 - 4 = ?', o: ['5', '6', '7', '8'], a: 1 },
    { q: '20 - 7 = ?', o: ['11', '12', '13', '14'], a: 2 },
    { q: '50 - 25 = ?', o: ['20', '25', '30', '35'], a: 1 },
  ]},
  { id: 'm3', icon: '*', title: 'Perkalian', desc: 'Kali-kalian', level: 'Dasar', xp: 15, questions: [
    { q: '7 x 8 = ?', o: ['54', '56', '58', '60'], a: 1 },
    { q: '9 x 9 = ?', o: ['72', '81', '90', '99'], a: 1 },
    { q: '12 x 12 = ?', o: ['124', '134', '144', '154'], a: 2 },
  ]},
  { id: 'm4', icon: '/', title: 'Pembagian', desc: 'Bagi-bagian', level: 'Dasar', xp: 15, questions: [
    { q: '20 / 4 = ?', o: ['4', '5', '6', '7'], a: 1 },
    { q: '72 / 8 = ?', o: ['8', '9', '10', '11'], a: 1 },
    { q: '100 / 5 = ?', o: ['15', '20', '25', '30'], a: 1 },
  ]},
];

const SCIENCE_LESSONS = [
  { id: 's1', icon: 'E', title: 'Tata Surya', desc: 'Planet-planet', level: 'Dasar', xp: 15, questions: [
    { q: 'Planet terdekat matahari?', o: ['Venus', 'Merkurius', 'Bumi', 'Mars'], a: 1 },
    { q: 'Planet terbesar?', o: ['Saturnus', 'Jupiter', 'Neptunus', 'Uranus'], a: 1 },
    { q: 'Planet merah?', o: ['Venus', 'Mars', 'Jupiter', 'Merkurius'], a: 1 },
    { q: 'Satelit bumi?', o: ['Matahari', 'Bulan', 'Mars', 'Venus'], a: 1 },
  ]},
  { id: 's2', icon: 'C', title: 'Kimia Dasar', desc: 'Unsur & senyawa', level: 'Dasar', xp: 15, questions: [
    { q: 'Simbol air?', o: ['CO2', 'H2O', 'O2', 'NaCl'], a: 1 },
    { q: 'Simbol oksigen?', o: ['O', 'O2', 'Ox', 'Og'], a: 1 },
    { q: 'Simbol emas?', o: ['Go', 'Au', 'Ag', 'Em'], a: 1 },
  ]},
  { id: 's3', icon: 'B', title: 'Biologi', desc: 'Makhluk hidup', level: 'Dasar', xp: 15, questions: [
    { q: 'Unit terkecil makhluk hidup?', o: ['Atom', 'Sel', 'Organ', 'Jaringan'], a: 1 },
    { q: 'Fotosintesis terjadi di?', o: ['Akar', 'Batang', 'Daun', 'Bunga'], a: 2 },
    { q: 'Alat pernapasan manusia?', o: ['Insang', 'Paru-paru', 'Trakea', 'Kulit'], a: 1 },
  ]},
];
