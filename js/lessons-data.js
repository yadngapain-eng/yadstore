...
const CODING_LESSONS = [
  ...
  {
    id: 'c11', icon: '🗄️', title: 'SQL Dasar', desc: 'Database query',
    level: 'Menengah', xp: 20, questions: [
  ...
  {
    id: 'c12', icon: '⚛️', title: 'React Dasar', desc: 'Library UI populer',
    level: 'Lanjutan', xp: 25, questions: [
...
const ENGLISH_LESSONS = [
  ...
  {
    id: 'e7', icon: '⏰', title: 'Time & Days', desc: 'Waktu & hari',
    level: 'Beginner', xp: 15, questions: [
  ...
  {
    id: 'e11', icon: '✈️', title: 'Travel', desc: 'Bahasa Inggris traveling',
    level: 'Intermediate', xp: 20, questions: [
      { q: '"Airport" artinya?', o: ['Bandara', 'Pelabuhan', 'Stasiun', 'Terminal'], a: 0 },
      { q: '"Ticket" artinya?', o: ['Tiket', 'Karcis', 'Paspor', 'Visa'], a: 0 },
      { q: '"Luggage" artinya?', o: ['Koper/bagasi', 'Tas kecil', 'Dompet', 'Jaket'], a: 0 },
      { q: '"Departure" artinya?', o: ['Keberangkatan', 'Kedatangan', 'Keterlambatan', 'Pembatalan'], a: 0 },
    ]
  },
  {
    id: 'e12', icon: '💬', title: 'Conversation', desc: 'Percakapan sehari-hari',
    level: 'Intermediate', xp: 20, questions: [
      { q: '"Excuse me" artinya?', o: ['Permisi', 'Maaf', 'Terima kasih', 'Halo'], a: 0 },
      { q: '"I don\'t understand" artinya?', o: ['Saya tidak mengerti', 'Saya mengerti', 'Saya tahu', 'Saya bingung'], a: 0 },
...
const MATH_LESSONS = [
  {
    id: 'm1', icon: '➕', title: 'Penjumlahan', desc: 'Tambah-tambahan',
    level: 'Dasar', xp: 10, questions: [
  ...
  {
    id: 'm2', icon: '➖', title: 'Pengurangan', desc: 'Kurang-kurangan',
    level: 'Dasar', xp: 10, questions: [
  ...
  {
    id: 'm3', icon: '✖️', title: 'Perkalian', desc: 'Kali-kalian',
    level: 'Dasar', xp: 15, questions: [
      { q: '7 × 8 = ?', o: ['54', '56', '58', '60'], a: 1 },
      { q: '9 × 9 = ?', o: ['72', '81', '90', '99'], a: 1 },
      { q: '12 × 12 = ?', o: ['124', '134', '144', '154'], a: 2 },
    ]
  },
  {
    id: 'm4', icon: '➗', title: 'Pembagian', desc: 'Bagi-bagian',
    level: 'Dasar', xp: 15, questions: [
...
const SCIENCE_LESSONS = [
  {
    id: 's1', icon: '🌍', title: 'Tata Surya', desc: 'Planet-planet',
    level: 'Dasar', xp: 15, questions: [
  ...
  {
    id: 's2', icon: '🧪', title: 'Kimia Dasar', desc: 'Unsur & senyawa',
    level: 'Dasar', xp: 15, questions: [
  ...
  {
    id: 's3', icon: '🧬', title: 'Biologi', desc: 'Makhluk hidup',
    level: 'Dasar', xp: 15, questions: [
      { q: 'Unit terkecil makhluk hidup?', o: ['Atom', 'Sel', 'Organ', 'Jaringan'], a: 1 },
      { q: 'Proses fotosintesis terjadi di?', o: ['Akar', 'Batang', 'Daun', 'Bunga'], a: 2 },
